...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg ebe7e3 # forground
  printf $printf_template_custom Ph 2b2b2b # background
  printf $printf_template_custom Pi ebe7e3 # bold color
  printf $printf_template_custom Pj 3a4055 # selection color
  printf $printf_template_custom Pk ebe7e3 # selected text color
  printf $printf_template_custom Pl ebe7e3 # cursor
