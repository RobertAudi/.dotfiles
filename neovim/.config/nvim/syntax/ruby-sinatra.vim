...
syntax match rubyKeywordAsMethod "\%(\%(\.\@<!\.\)\|::\)\_s*\%(get\|put\|post\|delete\|\)\>"       transparent contains=NONE
syntax match rubyKeywordAsMethod "\%(\%(\.\@<!\.\)\|::\)\_s*\%(set\|enable\|disable\|template\)\>" transparent contains=NONE
syntax match rubyKeywordAsMethod "\%(\%(\.\@<!\.\)\|::\)\_s*\%(register\|helpers\|use\)\>"         transparent contains=NONE
