...
zplugin ice pick"tipz.zsh" atload'source $ZDOTDIR/setup/plugins/molovo/tipz.zsh' wait"1" lucid
...
zplugin ice atload'source $ZDOTDIR/setup/plugins/_local/zsh-snippets.zsh' wait"2" lucid
zplugin load _local/zsh-snippets

zplugin ice atload'source $ZDOTDIR/setup/plugins/_local/zsh-hints.zsh' wait"2" lucid
