function! s:load_colorswatch_plugin() abort
  if !exists('*colorswatch#source') || !exists('*colorswatch#format')
    let g:loaded_colorswatch = 1

    call plug#load('colorswatch.vim')
  endif
endfunction


function! x2a#colorswatch#generate(...) abort
  call s:load_colorswatch_plugin()
