...
call <SID>highlight('DiagnosticSignError',              s:gui_error, s:gui01,   s:cterm_error, s:cterm01,      'none',            '')
call <SID>highlight('DiagnosticSignWarn',             s:gui_warning, s:gui01, s:cterm_warning, s:cterm01,      'none',            '')
call <SID>highlight('DiagnosticSignInfo',                s:gui_info, s:gui01,    s:cterm_info, s:cterm01,      'none',            '')
call <SID>highlight('DiagnosticSignHint',                s:gui_hint, s:gui01,    s:cterm_hint, s:cterm01,      'none',            '')
...
call <SID>highlight('ConflictMarkerBegin',     s:gui07, s:gui_error, s:cterm07, s:cterm09, '', '')
call <SID>highlight('ConflictMarkerEnd',       s:gui07, s:gui_error, s:cterm07, s:cterm09, '', '')
call <SID>highlight('ConflictMarkerSeparator', s:gui07, s:gui_error, s:cterm07, s:cterm09, '', '')

" FIXME: FIX THAT SHIT
" " Tasks comments
" call <SID>highlight('TasksFixme', s:gui07,   s:gui_error, s:cterm07,   s:cterm_error,      'none',            '')
" call <SID>highlight('TasksTodo',  s:gui07,    s:gui_hint, '',    s:cterm_hint,      'none',            '')
" call <SID>highlight('TasksHack',  s:gui07,    s:gui_hint, '',    s:cterm_hint,      'none',            '')
" call <SID>highlight('TasksWarn',  s:gui07, s:gui_warning, '', s:cterm_warning,      'none',            '')
" call <SID>highlight('TasksPerf',  s:gui07, s:gui_warning, '', s:cterm_warning,      'none',            '')
" call <SID>highlight('TasksNote',  s:gui07,    s:gui_info, '',    s:cterm_info,      'none',            '')
